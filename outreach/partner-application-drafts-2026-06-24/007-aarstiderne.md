# Aarstiderne Partner Application Draft
...
- Brand: Aarstiderne
- Main market: denmark
- Meal type: organic meal kit
- Fit note: Organic Danish meal boxes, produce boxes, and groceries
- Review page: /reviews/aarstiderne/
- Offer-check page: /go/aarstiderne/
- Official URL: https://www.aarstiderne.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Aarstiderne.
Do not replace the offer-check page with an affiliate tracking URL until Aarstiderne or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Aarstiderne, including:

- Aarstiderne review page: /reviews/aarstiderne/
- Aarstiderne offer-check page: /go/aarstiderne/
- Relevant country/category coverage for denmark and organic meal kit
...
We would like to join the Aarstiderne partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Aarstiderne coverage on Every Meal Guide
...
We have prepared Aarstiderne coverage here:

- Review page: /reviews/aarstiderne/
- Offer-check page: /go/aarstiderne/

Aarstiderne is currently listed as a organic meal kit option for denmark. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Aarstiderne coverage on Every Meal Guide

Hi Aarstiderne team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Aarstiderne is represented accurately.
