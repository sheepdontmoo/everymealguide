# CookUnity Partner Application Draft
...
- Fit note: chef-made prepared meals
- Review page: /reviews/cookunity/
- Offer-check page: /go/cookunity/
- Official URL: https://www.cookunity.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by CookUnity.
Do not replace the offer-check page with an affiliate tracking URL until CookUnity or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for CookUnity, including:

- CookUnity review page: /reviews/cookunity/
- CookUnity offer-check page: /go/cookunity/
...
We would like to join the CookUnity partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: CookUnity coverage on Every Meal Guide
...
We have prepared CookUnity coverage here:

- Review page: /reviews/cookunity/
- Offer-check page: /go/cookunity/

CookUnity is currently listed as a prepared meals option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: CookUnity coverage on Every Meal Guide

Hi CookUnity team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure CookUnity is represented accurately.
