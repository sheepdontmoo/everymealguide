# Chefgood Partner Application Draft
...
- Fit note: Australian healthy ready meals with prepared-meal subscription demand
- Review page: /reviews/chefgood/
- Offer-check page: /go/chefgood/
- Official URL: https://chefgood.com.au/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Chefgood.
Do not replace the offer-check page with an affiliate tracking URL until Chefgood or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Chefgood, including:

- Chefgood review page: /reviews/chefgood/
- Chefgood offer-check page: /go/chefgood/
...
We would like to join the Chefgood partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Chefgood coverage on Every Meal Guide
...
We have prepared Chefgood coverage here:

- Review page: /reviews/chefgood/
- Offer-check page: /go/chefgood/

Chefgood is currently listed as a prepared meals option for Australia. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Chefgood coverage on Every Meal Guide

Hi Chefgood team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Chefgood is represented accurately.
