# Clean Creations Partner Application Draft
...
- Brand: Clean Creations
- Main market: US
- Meal type: prepared meals
- Fit note: regional prepared meals
- Review page: /reviews/clean-creations/
- Offer-check page: /go/clean-creations/
- Official URL: Official URL to confirm

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Clean Creations.
Do not replace the offer-check page with an affiliate tracking URL until Clean Creations or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Clean Creations, including:

- Clean Creations review page: /reviews/clean-creations/
- Clean Creations offer-check page: /go/clean-creations/
...
We would like to join the Clean Creations partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Clean Creations coverage on Every Meal Guide

Hi Clean Creations team,
...
We have prepared Clean Creations coverage here:

- Review page: /reviews/clean-creations/
- Offer-check page: /go/clean-creations/

Clean Creations is currently listed as a prepared meals option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Clean Creations coverage on Every Meal Guide

Hi Clean Creations team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Clean Creations is represented accurately.
