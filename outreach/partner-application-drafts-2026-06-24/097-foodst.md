# FoodSt Partner Application Draft
...
- Fit note: homemade-style prepared meals
- Review page: /reviews/foodst/
- Offer-check page: /go/foodst/
- Official URL: https://foodst.com.au/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by FoodSt.
Do not replace the offer-check page with an affiliate tracking URL until FoodSt or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for FoodSt, including:

- FoodSt review page: /reviews/foodst/
- FoodSt offer-check page: /go/foodst/
...
We would like to join the FoodSt partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: FoodSt coverage on Every Meal Guide
...
We have prepared FoodSt coverage here:

- Review page: /reviews/foodst/
- Offer-check page: /go/foodst/

FoodSt is currently listed as a prepared meals option for Australia. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: FoodSt coverage on Every Meal Guide

Hi FoodSt team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure FoodSt is represented accurately.
