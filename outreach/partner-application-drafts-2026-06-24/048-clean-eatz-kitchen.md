# Clean Eatz Kitchen Partner Application Draft
...
- Brand: Clean Eatz Kitchen
- Main market: US
- Meal type: prepared meals
- Fit note: macro-friendly prepared meals with no-subscription boxes and continental US shipping
- Review page: /reviews/clean-eatz-kitchen/
- Offer-check page: /go/clean-eatz-kitchen/
- Official URL: https://www.cleaneatzkitchen.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Clean Eatz Kitchen.
Do not replace the offer-check page with an affiliate tracking URL until Clean Eatz Kitchen or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Clean Eatz Kitchen, including:

- Clean Eatz Kitchen review page: /reviews/clean-eatz-kitchen/
- Clean Eatz Kitchen offer-check page: /go/clean-eatz-kitchen/
- Relevant country/category coverage for US and prepared meals
...
We would like to join the Clean Eatz Kitchen partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Clean Eatz Kitchen coverage on Every Meal Guide

Hi Clean Eatz Kitchen team,
...
We have prepared Clean Eatz Kitchen coverage here:

- Review page: /reviews/clean-eatz-kitchen/
- Offer-check page: /go/clean-eatz-kitchen/

Clean Eatz Kitchen is currently listed as a prepared meals option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Clean Eatz Kitchen coverage on Every Meal Guide

Hi Clean Eatz Kitchen team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Clean Eatz Kitchen is represented accurately.
