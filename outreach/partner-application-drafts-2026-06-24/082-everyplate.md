# EveryPlate Partner Application Draft
...
- Fit note: cheap meal kit
- Review page: /reviews/everyplate/
- Offer-check page: /go/everyplate/
- Official URL: https://www.everyplate.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by EveryPlate.
Do not replace the offer-check page with an affiliate tracking URL until EveryPlate or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for EveryPlate, including:

- EveryPlate review page: /reviews/everyplate/
- EveryPlate offer-check page: /go/everyplate/
- Relevant country/category coverage for Global and budget meal kit
...
We would like to join the EveryPlate partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: EveryPlate coverage on Every Meal Guide
...
We have prepared EveryPlate coverage here:

- Review page: /reviews/everyplate/
- Offer-check page: /go/everyplate/

EveryPlate is currently listed as a budget meal kit option for Global. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: EveryPlate coverage on Every Meal Guide

Hi EveryPlate team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure EveryPlate is represented accurately.
