# Dublin Meal Prep Partner Application Draft
...
- Brand: Dublin Meal Prep
- Main market: Ireland
- Meal type: prepared meals
- Fit note: regional meal prep candidate
- Review page: /reviews/dublin-meal-prep/
- Offer-check page: /go/dublin-meal-prep/
- Official URL: Official URL to confirm

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Dublin Meal Prep.
Do not replace the offer-check page with an affiliate tracking URL until Dublin Meal Prep or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Dublin Meal Prep, including:

- Dublin Meal Prep review page: /reviews/dublin-meal-prep/
- Dublin Meal Prep offer-check page: /go/dublin-meal-prep/
...
We would like to join the Dublin Meal Prep partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Dublin Meal Prep coverage on Every Meal Guide

Hi Dublin Meal Prep team,
...
We have prepared Dublin Meal Prep coverage here:

- Review page: /reviews/dublin-meal-prep/
- Offer-check page: /go/dublin-meal-prep/

Dublin Meal Prep is currently listed as a prepared meals option for Ireland. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Dublin Meal Prep coverage on Every Meal Guide

Hi Dublin Meal Prep team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Dublin Meal Prep is represented accurately.
