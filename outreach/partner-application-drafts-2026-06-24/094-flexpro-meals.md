# FlexPro Meals Partner Application Draft
...
- Brand: FlexPro Meals
- Main market: US
- Meal type: fitness prepared meals
- Fit note: high-protein fitness meal prep with shipped prepared meals
- Review page: /reviews/flexpro-meals/
- Offer-check page: /go/flexpro-meals/
- Official URL: https://www.flexpromeals.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by FlexPro Meals.
Do not replace the offer-check page with an affiliate tracking URL until FlexPro Meals or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for FlexPro Meals, including:

- FlexPro Meals review page: /reviews/flexpro-meals/
- FlexPro Meals offer-check page: /go/flexpro-meals/
- Relevant country/category coverage for US and fitness prepared meals
...
We would like to join the FlexPro Meals partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: FlexPro Meals coverage on Every Meal Guide

Hi FlexPro Meals team,
...
We have prepared FlexPro Meals coverage here:

- Review page: /reviews/flexpro-meals/
- Offer-check page: /go/flexpro-meals/

FlexPro Meals is currently listed as a fitness prepared meals option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: FlexPro Meals coverage on Every Meal Guide

Hi FlexPro Meals team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure FlexPro Meals is represented accurately.
