# Ethey Partner Application Draft
...
- Fit note: fresh cooked-to-order prepared meals shipped ready to heat in Canada
- Review page: /reviews/ethey/
- Offer-check page: /go/ethey/
- Official URL: https://pgs.ethey.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Ethey.
Do not replace the offer-check page with an affiliate tracking URL until Ethey or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Ethey, including:

- Ethey review page: /reviews/ethey/
- Ethey offer-check page: /go/ethey/
...
We would like to join the Ethey partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Ethey coverage on Every Meal Guide
...
We have prepared Ethey coverage here:

- Review page: /reviews/ethey/
- Offer-check page: /go/ethey/

Ethey is currently listed as a prepared meals option for Canada. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Ethey coverage on Every Meal Guide

Hi Ethey team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Ethey is represented accurately.
