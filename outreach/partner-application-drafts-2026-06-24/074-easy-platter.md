# Easy Platter Partner Application Draft
...
- Meal type: meal kit
- Fit note: meal kit
- Review page: /reviews/easy-platter/
- Offer-check page: /go/easy-platter/
- Official URL: https://easyplatter.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Easy Platter.
Do not replace the offer-check page with an affiliate tracking URL until Easy Platter or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Easy Platter, including:

- Easy Platter review page: /reviews/easy-platter/
- Easy Platter offer-check page: /go/easy-platter/
...
We would like to join the Easy Platter partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Easy Platter coverage on Every Meal Guide

Hi Easy Platter team,
...
We have prepared Easy Platter coverage here:

- Review page: /reviews/easy-platter/
- Offer-check page: /go/easy-platter/

Easy Platter is currently listed as a meal kit option for Canada. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Easy Platter coverage on Every Meal Guide

Hi Easy Platter team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Easy Platter is represented accurately.
