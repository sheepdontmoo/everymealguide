# Balance Meals Partner Application Draft
...
- Review page: /reviews/balance-meals/
- Offer-check page: /go/balance-meals/
- Official URL: Official URL to confirm

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Balance Meals.
Do not replace the offer-check page with an affiliate tracking URL until Balance Meals or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Balance Meals, including:

- Balance Meals review page: /reviews/balance-meals/
- Balance Meals offer-check page: /go/balance-meals/
...
We would like to join the Balance Meals partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Balance Meals coverage on Every Meal Guide

Hi Balance Meals team,
...
We have prepared Balance Meals coverage here:

- Review page: /reviews/balance-meals/
- Offer-check page: /go/balance-meals/

Balance Meals is currently listed as a prepared meals option for UK. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Balance Meals coverage on Every Meal Guide

Hi Balance Meals team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Balance Meals is represented accurately.
