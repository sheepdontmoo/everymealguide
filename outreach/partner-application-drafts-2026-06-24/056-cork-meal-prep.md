# Cork Meal Prep Partner Application Draft
...
- Brand: Cork Meal Prep
- Main market: Ireland
- Meal type: prepared meals
- Fit note: regional meal prep candidate
- Review page: /reviews/cork-meal-prep/
- Offer-check page: /go/cork-meal-prep/
- Official URL: Official URL to confirm

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Cork Meal Prep.
Do not replace the offer-check page with an affiliate tracking URL until Cork Meal Prep or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Cork Meal Prep, including:

- Cork Meal Prep review page: /reviews/cork-meal-prep/
- Cork Meal Prep offer-check page: /go/cork-meal-prep/
...
We would like to join the Cork Meal Prep partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Cork Meal Prep coverage on Every Meal Guide

Hi Cork Meal Prep team,
...
We have prepared Cork Meal Prep coverage here:

- Review page: /reviews/cork-meal-prep/
- Offer-check page: /go/cork-meal-prep/

Cork Meal Prep is currently listed as a prepared meals option for Ireland. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Cork Meal Prep coverage on Every Meal Guide

Hi Cork Meal Prep team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Cork Meal Prep is represented accurately.
