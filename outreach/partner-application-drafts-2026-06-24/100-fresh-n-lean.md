# Fresh N Lean Partner Application Draft
...
- Fit note: formerly major prepared meal delivery brand that ceased operations
- Review page: /reviews/fresh-n-lean/
- Offer-check page: /go/fresh-n-lean/
- Official URL: https://www.freshnlean.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Fresh N Lean.
Do not replace the offer-check page with an affiliate tracking URL until Fresh N Lean or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Fresh N Lean, including:

- Fresh N Lean review page: /reviews/fresh-n-lean/
- Fresh N Lean offer-check page: /go/fresh-n-lean/
...
We would like to join the Fresh N Lean partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Fresh N Lean coverage on Every Meal Guide

Hi Fresh N Lean team,
...
We have prepared Fresh N Lean coverage here:

- Review page: /reviews/fresh-n-lean/
- Offer-check page: /go/fresh-n-lean/

Fresh N Lean is currently listed as a prepared meals option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Fresh N Lean coverage on Every Meal Guide

Hi Fresh N Lean team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Fresh N Lean is represented accurately.
