# Chef Meals Australia Partner Application Draft
...
- Brand: Chef Meals Australia
- Main market: Australia
- Meal type: prepared meals
- Fit note: prepared meals
- Review page: /reviews/chef-meals-australia/
- Offer-check page: /go/chef-meals-australia/
- Official URL: Official URL to confirm

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Chef Meals Australia.
Do not replace the offer-check page with an affiliate tracking URL until Chef Meals Australia or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Chef Meals Australia, including:

- Chef Meals Australia review page: /reviews/chef-meals-australia/
- Chef Meals Australia offer-check page: /go/chef-meals-australia/
...
We would like to join the Chef Meals Australia partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Chef Meals Australia coverage on Every Meal Guide

Hi Chef Meals Australia team,
...
We have prepared Chef Meals Australia coverage here:

- Review page: /reviews/chef-meals-australia/
- Offer-check page: /go/chef-meals-australia/

Chef Meals Australia is currently listed as a prepared meals option for Australia. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Chef Meals Australia coverage on Every Meal Guide

Hi Chef Meals Australia team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Chef Meals Australia is represented accurately.
