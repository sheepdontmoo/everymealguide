# Clean Eats Canada Partner Application Draft
...
- Brand: Clean Eats Canada
- Main market: Canada
- Meal type: prepared meals
- Fit note: prepared meals candidate
- Review page: /reviews/clean-eats-canada/
- Offer-check page: /go/clean-eats-canada/
- Official URL: Official URL to confirm

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Clean Eats Canada.
Do not replace the offer-check page with an affiliate tracking URL until Clean Eats Canada or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Clean Eats Canada, including:

- Clean Eats Canada review page: /reviews/clean-eats-canada/
- Clean Eats Canada offer-check page: /go/clean-eats-canada/
...
We would like to join the Clean Eats Canada partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Clean Eats Canada coverage on Every Meal Guide

Hi Clean Eats Canada team,
...
We have prepared Clean Eats Canada coverage here:

- Review page: /reviews/clean-eats-canada/
- Offer-check page: /go/clean-eats-canada/

Clean Eats Canada is currently listed as a prepared meals option for Canada. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Clean Eats Canada coverage on Every Meal Guide

Hi Clean Eats Canada team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Clean Eats Canada is represented accurately.
