# CookUnity Canada Partner Application Draft
...
- Brand: CookUnity Canada
- Main market: Canada
- Meal type: prepared meals
- Fit note: chef-made prepared meals route for Canada
- Review page: /reviews/cookunity-canada/
- Offer-check page: /go/cookunity-canada/
- Official URL: https://www.cookunity.com/en-ca

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by CookUnity Canada.
Do not replace the offer-check page with an affiliate tracking URL until CookUnity Canada or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for CookUnity Canada, including:

- CookUnity Canada review page: /reviews/cookunity-canada/
- CookUnity Canada offer-check page: /go/cookunity-canada/
...
We would like to join the CookUnity Canada partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: CookUnity Canada coverage on Every Meal Guide

Hi CookUnity Canada team,
...
We have prepared CookUnity Canada coverage here:

- Review page: /reviews/cookunity-canada/
- Offer-check page: /go/cookunity-canada/

CookUnity Canada is currently listed as a prepared meals option for Canada. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: CookUnity Canada coverage on Every Meal Guide

Hi CookUnity Canada team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure CookUnity Canada is represented accurately.
