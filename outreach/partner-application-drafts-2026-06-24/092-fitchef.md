# FitChef Partner Application Draft
...
- Brand: FitChef
- Main market: south-africa
- Meal type: prepared meals
- Fit note: South African healthy ready-to-eat meals, smoothies, snacks, and meal-plan kits
- Review page: /reviews/fitchef/
- Offer-check page: /go/fitchef/
- Official URL: https://orders.fitchef.co.za/customer/menu/meals

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by FitChef.
Do not replace the offer-check page with an affiliate tracking URL until FitChef or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for FitChef, including:

- FitChef review page: /reviews/fitchef/
- FitChef offer-check page: /go/fitchef/
- Relevant country/category coverage for south-africa and prepared meals
...
We would like to join the FitChef partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: FitChef coverage on Every Meal Guide
...
We have prepared FitChef coverage here:

- Review page: /reviews/fitchef/
- Offer-check page: /go/fitchef/

FitChef is currently listed as a prepared meals option for south-africa. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: FitChef coverage on Every Meal Guide

Hi FitChef team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure FitChef is represented accurately.
