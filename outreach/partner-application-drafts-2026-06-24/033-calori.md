# Calori Partner Application Draft
...
- Fit note: Finland meal-plan service cooking and delivering nutritious meals
- Review page: /reviews/calori/
- Offer-check page: /go/calori/
- Official URL: https://calori.fi/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Calori.
Do not replace the offer-check page with an affiliate tracking URL until Calori or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Calori, including:

- Calori review page: /reviews/calori/
- Calori offer-check page: /go/calori/
- Relevant country/category coverage for finland and prepared meals
...
We would like to join the Calori partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Calori coverage on Every Meal Guide
...
We have prepared Calori coverage here:

- Review page: /reviews/calori/
- Offer-check page: /go/calori/

Calori is currently listed as a prepared meals option for finland. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Calori coverage on Every Meal Guide

Hi Calori team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Calori is represented accurately.
