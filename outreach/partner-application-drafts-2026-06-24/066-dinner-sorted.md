# Dinner Sorted Partner Application Draft
...
- Meal type: meal kit
- Fit note: family meal planning candidate
- Review page: /reviews/dinner-sorted/
- Offer-check page: /go/dinner-sorted/
- Official URL: Official URL to confirm

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Dinner Sorted.
Do not replace the offer-check page with an affiliate tracking URL until Dinner Sorted or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Dinner Sorted, including:

- Dinner Sorted review page: /reviews/dinner-sorted/
- Dinner Sorted offer-check page: /go/dinner-sorted/
- Relevant country/category coverage for Australia and meal kit
...
We would like to join the Dinner Sorted partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Dinner Sorted coverage on Every Meal Guide

Hi Dinner Sorted team,
...
We have prepared Dinner Sorted coverage here:

- Review page: /reviews/dinner-sorted/
- Offer-check page: /go/dinner-sorted/

Dinner Sorted is currently listed as a meal kit option for Australia. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Dinner Sorted coverage on Every Meal Guide

Hi Dinner Sorted team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Dinner Sorted is represented accurately.
