# Epicured Partner Application Draft
...
- Brand: Epicured
- Main market: US
- Meal type: medical diet meals
- Fit note: low-FODMAP and gluten-free fresh meal delivery for digestive health
- Review page: /reviews/epicured/
- Offer-check page: /go/epicured/
- Official URL: https://www.epicured.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Epicured.
Do not replace the offer-check page with an affiliate tracking URL until Epicured or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Epicured, including:

- Epicured review page: /reviews/epicured/
- Epicured offer-check page: /go/epicured/
- Relevant country/category coverage for US and medical diet meals
...
We would like to join the Epicured partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Epicured coverage on Every Meal Guide
...
We have prepared Epicured coverage here:

- Review page: /reviews/epicured/
- Offer-check page: /go/epicured/

Epicured is currently listed as a medical diet meals option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Epicured coverage on Every Meal Guide

Hi Epicured team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Epicured is represented accurately.
