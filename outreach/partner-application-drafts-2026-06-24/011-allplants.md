# allplants Partner Application Draft
...
- Brand: allplants
- Main market: UK
- Meal type: frozen plant-based meals
- Fit note: UK plant-based frozen meal brand with strong residual search demand and route needing live checkout check
- Review page: /reviews/allplants/
- Offer-check page: /go/allplants/
- Official URL: https://allplants.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by allplants.
Do not replace the offer-check page with an affiliate tracking URL until allplants or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for allplants, including:

- allplants review page: /reviews/allplants/
- allplants offer-check page: /go/allplants/
- Relevant country/category coverage for UK and frozen plant-based meals
...
We would like to join the allplants partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: allplants coverage on Every Meal Guide
...
We have prepared allplants coverage here:

- Review page: /reviews/allplants/
- Offer-check page: /go/allplants/

allplants is currently listed as a frozen plant-based meals option for UK. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: allplants coverage on Every Meal Guide

Hi allplants team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure allplants is represented accurately.
