# Eatto Partner Application Draft
...
- Brand: Eatto
- Main market: Ireland
- Meal type: frozen prepared meals
- Fit note: Irish frozen prepared meal delivery brand with convenient ready meals and family dinner relevance
- Review page: /reviews/eatto/
- Offer-check page: /go/eatto/
- Official URL: https://eatto.ie/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Eatto.
Do not replace the offer-check page with an affiliate tracking URL until Eatto or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Eatto, including:

- Eatto review page: /reviews/eatto/
- Eatto offer-check page: /go/eatto/
- Relevant country/category coverage for Ireland and frozen prepared meals
...
We would like to join the Eatto partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Eatto coverage on Every Meal Guide
...
We have prepared Eatto coverage here:

- Review page: /reviews/eatto/
- Offer-check page: /go/eatto/

Eatto is currently listed as a frozen prepared meals option for Ireland. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Eatto coverage on Every Meal Guide

Hi Eatto team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Eatto is represented accurately.
