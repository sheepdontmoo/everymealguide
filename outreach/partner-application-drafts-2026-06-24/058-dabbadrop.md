# DabbaDrop Partner Application Draft
...
- Brand: DabbaDrop
- Main market: UK
- Meal type: plant-based prepared meals
- Fit note: London plant-based Indian tiffin delivery with reusable steel dabbas and fresh ready-to-heat meals
- Review page: /reviews/dabbadrop/
- Offer-check page: /go/dabbadrop/
- Official URL: https://dabbadrop.co.uk/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by DabbaDrop.
Do not replace the offer-check page with an affiliate tracking URL until DabbaDrop or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for DabbaDrop, including:

- DabbaDrop review page: /reviews/dabbadrop/
- DabbaDrop offer-check page: /go/dabbadrop/
- Relevant country/category coverage for UK and plant-based prepared meals
...
We would like to join the DabbaDrop partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: DabbaDrop coverage on Every Meal Guide
...
We have prepared DabbaDrop coverage here:

- Review page: /reviews/dabbadrop/
- Offer-check page: /go/dabbadrop/

DabbaDrop is currently listed as a plant-based prepared meals option for UK. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: DabbaDrop coverage on Every Meal Guide

Hi DabbaDrop team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure DabbaDrop is represented accurately.
