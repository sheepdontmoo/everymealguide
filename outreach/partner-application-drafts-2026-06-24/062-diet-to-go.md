# Diet-to-Go Partner Application Draft
...
- Fit note: diet prepared meal delivery brand for weight-loss and structured plans
- Review page: /reviews/diet-to-go/
- Offer-check page: /go/diet-to-go/
- Official URL: https://www.diettogo.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Diet-to-Go.
Do not replace the offer-check page with an affiliate tracking URL until Diet-to-Go or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Diet-to-Go, including:

- Diet-to-Go review page: /reviews/diet-to-go/
- Diet-to-Go offer-check page: /go/diet-to-go/
- Relevant country/category coverage for US and diet prepared meals
...
We would like to join the Diet-to-Go partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Diet-to-Go coverage on Every Meal Guide
...
We have prepared Diet-to-Go coverage here:

- Review page: /reviews/diet-to-go/
- Offer-check page: /go/diet-to-go/

Diet-to-Go is currently listed as a diet prepared meals option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Diet-to-Go coverage on Every Meal Guide

Hi Diet-to-Go team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Diet-to-Go is represented accurately.
