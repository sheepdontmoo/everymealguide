# Dinnerly Partner Application Draft
...
- Review page: /reviews/dinnerly/
- Offer-check page: /go/dinnerly/
- Official URL: https://dinnerly.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Dinnerly.
Do not replace the offer-check page with an affiliate tracking URL until Dinnerly or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Dinnerly, including:

- Dinnerly review page: /reviews/dinnerly/
- Dinnerly offer-check page: /go/dinnerly/
...
We would like to join the Dinnerly partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Dinnerly coverage on Every Meal Guide
...
We have prepared Dinnerly coverage here:

- Review page: /reviews/dinnerly/
- Offer-check page: /go/dinnerly/

Dinnerly is currently listed as a budget meal kit option for Global. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Dinnerly coverage on Every Meal Guide

Hi Dinnerly team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Dinnerly is represented accurately.
