# Cook it Partner Application Draft
...
- Main market: Canada
- Meal type: meal kit
- Fit note: Quebec and Canada meal-kit brand with recipe boxes and prepared dinner relevance
- Review page: /reviews/cook-it/
- Offer-check page: /go/cook-it/
- Official URL: https://www.chefcookit.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Cook it.
Do not replace the offer-check page with an affiliate tracking URL until Cook it or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Cook it, including:

- Cook it review page: /reviews/cook-it/
- Cook it offer-check page: /go/cook-it/
...
We would like to join the Cook it partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Cook it coverage on Every Meal Guide
...
We have prepared Cook it coverage here:

- Review page: /reviews/cook-it/
- Offer-check page: /go/cook-it/

Cook it is currently listed as a meal kit option for Canada. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Cook it coverage on Every Meal Guide

Hi Cook it team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Cook it is represented accurately.
