# ButcherBox Partner Application Draft
...
- Brand: ButcherBox
- Main market: US
- Meal type: protein box
- Fit note: meat and seafood subscription box for freezer and dinner-protein planning
- Review page: /reviews/butcherbox/
- Offer-check page: /go/butcherbox/
- Official URL: https://www.butcherbox.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by ButcherBox.
Do not replace the offer-check page with an affiliate tracking URL until ButcherBox or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for ButcherBox, including:

- ButcherBox review page: /reviews/butcherbox/
- ButcherBox offer-check page: /go/butcherbox/
- Relevant country/category coverage for US and protein box
...
We would like to join the ButcherBox partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: ButcherBox coverage on Every Meal Guide
...
We have prepared ButcherBox coverage here:

- Review page: /reviews/butcherbox/
- Offer-check page: /go/butcherbox/

ButcherBox is currently listed as a protein box option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: ButcherBox coverage on Every Meal Guide

Hi ButcherBox team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure ButcherBox is represented accurately.
