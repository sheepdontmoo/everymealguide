# Blue Apron Partner Application Draft
...
- Main market: US
- Meal type: meal kit
- Fit note: US mainstream meal-kit brand with recipes, pre-portioned ingredients, and broad comparison demand
- Review page: /reviews/blue-apron/
- Offer-check page: /go/blue-apron/
- Official URL: https://www.blueapron.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Blue Apron.
Do not replace the offer-check page with an affiliate tracking URL until Blue Apron or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Blue Apron, including:

- Blue Apron review page: /reviews/blue-apron/
- Blue Apron offer-check page: /go/blue-apron/
- Relevant country/category coverage for US and meal kit
...
We would like to join the Blue Apron partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Blue Apron coverage on Every Meal Guide
...
We have prepared Blue Apron coverage here:

- Review page: /reviews/blue-apron/
- Offer-check page: /go/blue-apron/

Blue Apron is currently listed as a meal kit option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Blue Apron coverage on Every Meal Guide

Hi Blue Apron team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Blue Apron is represented accurately.
