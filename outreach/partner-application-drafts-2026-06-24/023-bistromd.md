# bistroMD Partner Application Draft
...
- Fit note: dietitian-designed chef-prepared weight-loss and wellness meal delivery with specialized programs
- Review page: /reviews/bistromd/
- Offer-check page: /go/bistromd/
- Official URL: https://www.bistromd.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by bistroMD.
Do not replace the offer-check page with an affiliate tracking URL until bistroMD or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for bistroMD, including:

- bistroMD review page: /reviews/bistromd/
- bistroMD offer-check page: /go/bistromd/
...
We would like to join the bistroMD partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: bistroMD coverage on Every Meal Guide
...
We have prepared bistroMD coverage here:

- Review page: /reviews/bistromd/
- Offer-check page: /go/bistromd/

bistroMD is currently listed as a diet prepared meals option for US. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: bistroMD coverage on Every Meal Guide

Hi bistroMD team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure bistroMD is represented accurately.
