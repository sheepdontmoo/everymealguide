# Chefs for Foodies Partner Application Draft
...
- Main market: UK
- Meal type: chef-led kits
- Fit note: chef-led meal kit
- Review page: /reviews/chefs-for-foodies/
- Offer-check page: /go/chefs-for-foodies/
- Official URL: https://chefsforfoodies.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Chefs for Foodies.
Do not replace the offer-check page with an affiliate tracking URL until Chefs for Foodies or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Chefs for Foodies, including:

- Chefs for Foodies review page: /reviews/chefs-for-foodies/
- Chefs for Foodies offer-check page: /go/chefs-for-foodies/
- Relevant country/category coverage for UK and chef-led kits
...
We would like to join the Chefs for Foodies partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Chefs for Foodies coverage on Every Meal Guide

Hi Chefs for Foodies team,
...
We have prepared Chefs for Foodies coverage here:

- Review page: /reviews/chefs-for-foodies/
- Offer-check page: /go/chefs-for-foodies/

Chefs for Foodies is currently listed as a chef-led kits option for UK. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Chefs for Foodies coverage on Every Meal Guide

Hi Chefs for Foodies team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Chefs for Foodies is represented accurately.
