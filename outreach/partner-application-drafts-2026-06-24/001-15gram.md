# 15gram Partner Application Draft
...
- Main market: Belgium
- Meal type: meal kit
- Fit note: Belgian meal box and recipe planning brand with grocery-dinner relevance
- Review page: /reviews/15gram/
- Offer-check page: /go/15gram/
- Official URL: https://15gram.be/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by 15gram.
Do not replace the offer-check page with an affiliate tracking URL until 15gram or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for 15gram, including:

- 15gram review page: /reviews/15gram/
- 15gram offer-check page: /go/15gram/
- Relevant country/category coverage for Belgium and meal kit
...
We would like to join the 15gram partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: 15gram coverage on Every Meal Guide
...
We have prepared 15gram coverage here:

- Review page: /reviews/15gram/
- Offer-check page: /go/15gram/

15gram is currently listed as a meal kit option for Belgium. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: 15gram coverage on Every Meal Guide

Hi 15gram team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure 15gram is represented accurately.
