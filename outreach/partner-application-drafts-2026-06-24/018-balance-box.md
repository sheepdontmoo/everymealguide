# Balance Box Partner Application Draft
...
- Fit note: UK healthy diet meal delivery and calorie-controlled meal plan brand
- Review page: /reviews/balance-box/
- Offer-check page: /go/balance-box/
- Official URL: https://www.balancebox.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Balance Box.
Do not replace the offer-check page with an affiliate tracking URL until Balance Box or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Balance Box, including:

- Balance Box review page: /reviews/balance-box/
- Balance Box offer-check page: /go/balance-box/
- Relevant country/category coverage for UK and diet prepared meals
...
We would like to join the Balance Box partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Balance Box coverage on Every Meal Guide
...
We have prepared Balance Box coverage here:

- Review page: /reviews/balance-box/
- Offer-check page: /go/balance-box/

Balance Box is currently listed as a diet prepared meals option for UK. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Balance Box coverage on Every Meal Guide

Hi Balance Box team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Balance Box is represented accurately.
