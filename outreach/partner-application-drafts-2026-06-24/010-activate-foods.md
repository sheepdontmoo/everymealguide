# Activate Foods Partner Application Draft
...
- Brand: Activate Foods
- Main market: Australia
- Meal type: prepared meals
- Fit note: prepared meals
- Review page: /reviews/activate-foods/
- Offer-check page: /go/activate-foods/
- Official URL: Official URL to confirm

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Activate Foods.
Do not replace the offer-check page with an affiliate tracking URL until Activate Foods or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Activate Foods, including:

- Activate Foods review page: /reviews/activate-foods/
- Activate Foods offer-check page: /go/activate-foods/
...
We would like to join the Activate Foods partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Activate Foods coverage on Every Meal Guide

Hi Activate Foods team,
...
We have prepared Activate Foods coverage here:

- Review page: /reviews/activate-foods/
- Offer-check page: /go/activate-foods/

Activate Foods is currently listed as a prepared meals option for Australia. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Activate Foods coverage on Every Meal Guide

Hi Activate Foods team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Activate Foods is represented accurately.
