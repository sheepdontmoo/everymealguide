# Dineamic Partner Application Draft
...
- Fit note: Australian prepared ready-meal brand with chef-made family and healthy dinner range
- Review page: /reviews/dineamic/
- Offer-check page: /go/dineamic/
- Official URL: https://www.dineamic.com.au/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Dineamic.
Do not replace the offer-check page with an affiliate tracking URL until Dineamic or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Dineamic, including:

- Dineamic review page: /reviews/dineamic/
- Dineamic offer-check page: /go/dineamic/
...
We would like to join the Dineamic partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Dineamic coverage on Every Meal Guide
...
We have prepared Dineamic coverage here:

- Review page: /reviews/dineamic/
- Offer-check page: /go/dineamic/

Dineamic is currently listed as a prepared meals option for Australia. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Dineamic coverage on Every Meal Guide

Hi Dineamic team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Dineamic is represented accurately.
