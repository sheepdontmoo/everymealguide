# Field Doctor Partner Application Draft
...
- Brand: Field Doctor
- Main market: UK
- Meal type: frozen diet prepared meals
- Fit note: UK dietitian-designed frozen healthy ready meals with high-protein, low-FODMAP, gluten-free, and health ranges
- Review page: /reviews/field-doctor/
- Offer-check page: /go/field-doctor/
- Official URL: https://www.fielddoctor.co.uk/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Field Doctor.
Do not replace the offer-check page with an affiliate tracking URL until Field Doctor or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Field Doctor, including:

- Field Doctor review page: /reviews/field-doctor/
- Field Doctor offer-check page: /go/field-doctor/
- Relevant country/category coverage for UK and frozen diet prepared meals
...
We would like to join the Field Doctor partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Field Doctor coverage on Every Meal Guide

Hi Field Doctor team,
...
We have prepared Field Doctor coverage here:

- Review page: /reviews/field-doctor/
- Offer-check page: /go/field-doctor/

Field Doctor is currently listed as a frozen diet prepared meals option for UK. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Field Doctor coverage on Every Meal Guide

Hi Field Doctor team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Field Doctor is represented accurately.
