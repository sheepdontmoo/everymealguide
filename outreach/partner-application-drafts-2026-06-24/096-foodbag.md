# Foodbag Partner Application Draft
...
- Brand: Foodbag
- Main market: belgium
- Meal type: meal kit and ready meals
- Fit note: Belgian meal box with local ingredients, no-subscription ordering, and ready-made options
- Review page: /reviews/foodbag/
- Offer-check page: /go/foodbag/
- Official URL: https://www.foodbag.be/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Foodbag.
Do not replace the offer-check page with an affiliate tracking URL until Foodbag or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Foodbag, including:

- Foodbag review page: /reviews/foodbag/
- Foodbag offer-check page: /go/foodbag/
- Relevant country/category coverage for belgium and meal kit and ready meals
...
We would like to join the Foodbag partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Foodbag coverage on Every Meal Guide
...
We have prepared Foodbag coverage here:

- Review page: /reviews/foodbag/
- Offer-check page: /go/foodbag/

Foodbag is currently listed as a meal kit and ready meals option for belgium. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Foodbag coverage on Every Meal Guide

Hi Foodbag team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Foodbag is represented accurately.
