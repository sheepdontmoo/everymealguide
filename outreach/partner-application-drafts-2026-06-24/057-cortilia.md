# Cortilia Partner Application Draft
...
- Brand: Cortilia
- Main market: Italy
- Meal type: grocery dinner delivery
- Fit note: Italian online grocery and fresh food delivery brand with meal-planning relevance
- Review page: /reviews/cortilia/
- Offer-check page: /go/cortilia/
- Official URL: https://www.cortilia.it/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Cortilia.
Do not replace the offer-check page with an affiliate tracking URL until Cortilia or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Cortilia, including:

- Cortilia review page: /reviews/cortilia/
- Cortilia offer-check page: /go/cortilia/
- Relevant country/category coverage for Italy and grocery dinner delivery
...
We would like to join the Cortilia partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Cortilia coverage on Every Meal Guide
...
We have prepared Cortilia coverage here:

- Review page: /reviews/cortilia/
- Offer-check page: /go/cortilia/

Cortilia is currently listed as a grocery dinner delivery option for Italy. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Cortilia coverage on Every Meal Guide

Hi Cortilia team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Cortilia is represented accurately.
