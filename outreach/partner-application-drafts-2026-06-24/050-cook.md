# COOK Partner Application Draft
...
- Fit note: UK frozen prepared meals and family dinner delivery/collection brand
- Review page: /reviews/cook/
- Offer-check page: /go/cook/
- Official URL: https://www.cookfood.net/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by COOK.
Do not replace the offer-check page with an affiliate tracking URL until COOK or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for COOK, including:

- COOK review page: /reviews/cook/
- COOK offer-check page: /go/cook/
- Relevant country/category coverage for UK and frozen meals
...
We would like to join the COOK partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: COOK coverage on Every Meal Guide
...
We have prepared COOK coverage here:

- Review page: /reviews/cook/
- Offer-check page: /go/cook/

COOK is currently listed as a frozen meals option for UK. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: COOK coverage on Every Meal Guide

Hi COOK team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure COOK is represented accurately.
