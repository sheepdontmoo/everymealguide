# Chefs Plate Partner Application Draft
...
- Main market: Canada
- Meal type: meal kit
- Fit note: budget Canadian meal-kit brand with broad national meal-kit demand and affiliate potential
- Review page: /reviews/chefs-plate/
- Offer-check page: /go/chefs-plate/
- Official URL: https://www.chefsplate.com/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Chefs Plate.
Do not replace the offer-check page with an affiliate tracking URL until Chefs Plate or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Chefs Plate, including:

- Chefs Plate review page: /reviews/chefs-plate/
- Chefs Plate offer-check page: /go/chefs-plate/
- Relevant country/category coverage for Canada and meal kit
...
We would like to join the Chefs Plate partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Chefs Plate coverage on Every Meal Guide
...
We have prepared Chefs Plate coverage here:

- Review page: /reviews/chefs-plate/
- Offer-check page: /go/chefs-plate/

Chefs Plate is currently listed as a meal kit option for Canada. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Chefs Plate coverage on Every Meal Guide

Hi Chefs Plate team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Chefs Plate is represented accurately.
