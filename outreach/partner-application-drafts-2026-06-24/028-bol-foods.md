# BOL Foods Partner Application Draft
...
- Brand: BOL Foods
- Main market: UK
- Meal type: ready meals
- Fit note: retail ready meals adjacent
- Review page: /reviews/bol-foods/
- Offer-check page: /go/bol-foods/
- Official URL: Official URL to confirm

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by BOL Foods.
Do not replace the offer-check page with an affiliate tracking URL until BOL Foods or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for BOL Foods, including:

- BOL Foods review page: /reviews/bol-foods/
- BOL Foods offer-check page: /go/bol-foods/
- Relevant country/category coverage for UK and ready meals
...
We would like to join the BOL Foods partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: BOL Foods coverage on Every Meal Guide
...
We have prepared BOL Foods coverage here:

- Review page: /reviews/bol-foods/
- Offer-check page: /go/bol-foods/

BOL Foods is currently listed as a ready meals option for UK. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: BOL Foods coverage on Every Meal Guide

Hi BOL Foods team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure BOL Foods is represented accurately.
