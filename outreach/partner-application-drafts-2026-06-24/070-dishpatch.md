# Dishpatch Partner Application Draft
...
- Brand: Dishpatch
- Main market: UK
- Meal type: restaurant meal kits
- Fit note: UK restaurant meal-kit and finish-at-home dinner delivery brand
- Review page: /reviews/dishpatch/
- Offer-check page: /go/dishpatch/
- Official URL: https://dishpatch.co.uk/

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Dishpatch.
Do not replace the offer-check page with an affiliate tracking URL until Dishpatch or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Dishpatch, including:

- Dishpatch review page: /reviews/dishpatch/
- Dishpatch offer-check page: /go/dishpatch/
- Relevant country/category coverage for UK and restaurant meal kits
...
We would like to join the Dishpatch partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Dishpatch coverage on Every Meal Guide
...
We have prepared Dishpatch coverage here:

- Review page: /reviews/dishpatch/
- Offer-check page: /go/dishpatch/

Dishpatch is currently listed as a restaurant meal kits option for UK. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Dishpatch coverage on Every Meal Guide

Hi Dishpatch team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Dishpatch is represented accurately.
