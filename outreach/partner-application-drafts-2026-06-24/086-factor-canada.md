# Factor Canada Partner Application Draft
...
- Fit note: ready-to-eat Factor meal delivery available in Canada with prepared meals and high-protein demand
- Review page: /reviews/factor-canada/
- Offer-check page: /go/factor-canada/
- Official URL: https://www.factor75.com/pages/canada

## Evidence boundary

Do not claim this has been submitted.
Do not claim Every Meal Guide is approved by Factor Canada.
Do not replace the offer-check page with an affiliate tracking URL until Factor Canada or its affiliate network approves the site and provides an approved URL.
...
We have built dedicated coverage for Factor Canada, including:

- Factor Canada review page: /reviews/factor-canada/
- Factor Canada offer-check page: /go/factor-canada/
...
We would like to join the Factor Canada partner program and use approved tracking links only after acceptance.

## Direct partnership email draft

Subject: Factor Canada coverage on Every Meal Guide

Hi Factor Canada team,
...
We have prepared Factor Canada coverage here:

- Review page: /reviews/factor-canada/
- Offer-check page: /go/factor-canada/

Factor Canada is currently listed as a prepared meals option for Canada. Before we strengthen the recommendation or add offer details, I wanted to ask if you have an affiliate program, direct partner route, approved creative assets, or preferred offer terms we should use.
...
Subject: Re: Factor Canada coverage on Every Meal Guide

Hi Factor Canada team,

Quick follow-up on this. We are building out meal-delivery comparison pages by country and meal type, and we want to make sure Factor Canada is represented accurately.
